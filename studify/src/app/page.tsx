    ...
    <div className="flex min-h-screen flex-col bg-[#FDFBF7] dark:bg-[#1C1917] text-[#2D3436] dark:text-[#E7E5E4] px-6 safe-top pb-6 font-sans transition-colors duration-500 md:px-10 md:py-8">
      ...
      <div className="md:max-w-5xl md:mx-auto md:w-full md:grid md:grid-cols-[1.15fr_1fr] md:gap-6 md:items-start">
        ...
        <motion.div
          ...
          className="relative w-full h-80 mb-8 md:mb-0 md:h-[460px]"
        >
          {/* Shadow Layer */}
        ...
        <div className="flex flex-col gap-4">
          <div className="grid grid-cols-2 gap-4">
            ...
            <Link href="/exam">
              ...
              >
                ...
                <div className="w-full bg-black/10 dark:bg-black/40 h-2 rounded-full overflow-hidden">
                  <div className="h-full bg-white/90 dark:bg-current transition-all duration-1000" style={{ width: `${examData.prepLevel}%` }} />
                </div>
              </motion.div>
            </Link>
            ...
            <Link href="/attendance">
              <motion.div
                ...
                className="bg-[#FFDAC1] text-[#B07D62] dark:bg-[#292524] dark:text-orange-200 dark:border-2 dark:border-orange-400/20 rounded-[25px] p-5 h-48 flex flex-col justify-between shadow-lg cursor-pointer hover:scale-105 transition-colors"
              >
          ...
          <Link href="/simulator">
            <motion.div
              ...
              className="w-full bg-[#2D3436] dark:bg-[#292524] dark:border dark:border-[#44403C] text-white dark:text-[#E7E5E4] p-5 rounded-[25px] flex items-center justify-between shadow-xl cursor-pointer hover:scale-[1.02] transition-transform"
            >
              ...
              <ArrowRight size={20} className="dark:text-gray-500" />
            </motion.div>
          </Link>
        </div>
      </div>
